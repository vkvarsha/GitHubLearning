...
public class Amazon_LinkText_28C {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		Thread.sleep(2000);
		WebElement MobileLink = driver.findElement(By.linkText("Buy Again"));
		MobileLink.click();
		
		Thread.sleep(1000);
		WebElement HI = driver.findElement(By.partialLinkText("Improvement"));
		HI.click();
