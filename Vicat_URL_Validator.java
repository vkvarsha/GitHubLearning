...
public class Vicat_URL_Validator

{
	...
	public void links() throws InterruptedException, IOException
	{
		...
		driver.manage().window().maximize();
		 ui ="https://qa-vicat.autoplant.in/AutoplantWeb";
		driver.get(ui);
	...
	public void validator() throws IOException
	{
		  URI uri = URI.create(ui);
	        ...
	        if (responseCode == HttpURLConnection.HTTP_OK) {
	            System.out.println(ui + " Link is valid");
	        } else {
	            System.out.println(ui + " Link is Invalid");
	        }
	    }
